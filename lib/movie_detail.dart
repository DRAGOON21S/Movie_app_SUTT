...
import 'package:movie_api_app/api/api.dart';
import 'package:movie_api_app/api/api2.dart';
import 'package:movie_api_app/homepage.dart';
import 'package:movie_api_app/logic/str_double.dart';
...
class _Movie_detailState extends State<Movie_detail> {
  ...
  @override
  void initState(){
    getdetail=Api2().getmoviedetail(widget.id);
